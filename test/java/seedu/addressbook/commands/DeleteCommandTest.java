...
public class DeleteCommandTest {
    ...
    public void setUp() throws Exception {
        Person johnDoe = new Person(new Name("John Doe"), new Phone("61234567", false),
                new Email("john@doe.com", false), new Address("395C Ben Road, Blk 123, #09-100, S670440", false), new UniqueTagList());
        Person janeDoe = new Person(new Name("Jane Doe"), new Phone("91234567", false),
                new Email("jane@doe.com", false), new Address("33G Ohm Road, Blk 453, #29-50, S675441", false), new UniqueTagList());
        Person samDoe = new Person(new Name("Sam Doe"), new Phone("63345566", false),
                new Email("sam@doe.com", false), new Address("55G Abc Road, Blk 543, #19-16,S672445", false), new UniqueTagList());
        Person davidGrant = new Person(new Name("David Grant"), new Phone("61121122", false),
                new Email("david@grant.com", false), new Address("44H Define Road, Blk 404, #12-12, S670420", false),
                new UniqueTagList());
    ...
    public void execute_targetPersonNotInAddressBook_returnsPersonNotFoundMessage()
        ...
        Person notInAddressBookPerson = new Person(new Name("Not In Book"), new Phone("63331444", false),
                new Email("notin@book.com", false), new Address("156D Grant Road,BLK 1239, #08-123, S523492", false), new UniqueTagList());
